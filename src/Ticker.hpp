...
const float div_to_factor[72] = {1.f / 96.f, 1.f / 92.f, 1.f / 88.f, 1.f / 84.f, 1.f / 80.f, 1.f / 76.f, 1.f / 72.f, 1.f / 68.f, 1.f / 64.f, 1.f / 60.f,
								 ...
								 1.f / 3.f, 1.f / 2.5f, 1.f / 2.f, 1.f / 1.33333f, 1.f, 1.33333f, 1.5f, 2.f, 2.5f, 3.f, 3.5f, 4.f, 5.f, 6.f, 7.f, 8.f, 9.f,
								 10.f, 12.f, 16.f, 18.f, 20.f, 24.f, 28.f, 32.f, 36.f, 40.f, 44.f, 48.f, 52.f, 56.f, 60.f, 64.f, 68.f, 72.f, 76.f, 80.f,
								 84.f, 88.f, 92.f, 96.f};

const char div_to_text[72] = {"/ 96 . 0", "/ 92 . 0", "/ 88 . 0", "/ 84 . 0", "/ 80 . 0", "/ 76 . 0", "/ 72 . 0", "/ 68 . 0", "/ 64 . 0", "/ 60 . 0", "/ 56 . 0",
