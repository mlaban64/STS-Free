...
const float PENTATONIC_SCALES[2][12][5] = {
	...
	{
		// C
		{C4_NOTE, C4_NOTE + MAJOR_SECOND, C4_NOTE + MAJOR_THIRD, C4_NOTE + PERFECT_FOURTH, C4_NOTE + PERFECT_FIFTH},
		// C#/Db
		{Db4_NOTE, Db4_NOTE + MAJOR_SECOND, Db4_NOTE + MAJOR_THIRD, Db4_NOTE + PERFECT_FOURTH, Db4_NOTE + PERFECT_FIFTH},
		// D
		{D4_NOTE, D4_NOTE + MAJOR_SECOND, D4_NOTE + MAJOR_THIRD, D4_NOTE + PERFECT_FOURTH, D4_NOTE + PERFECT_FIFTH},
		// D#/Eb
		{Eb4_NOTE, Eb4_NOTE + MAJOR_SECOND, Eb4_NOTE + MAJOR_THIRD, Eb4_NOTE + PERFECT_FOURTH, Eb4_NOTE + PERFECT_FIFTH},
		// E
		{E4_NOTE, E4_NOTE + MAJOR_SECOND, E4_NOTE + MAJOR_THIRD, E4_NOTE + PERFECT_FOURTH, E4_NOTE + PERFECT_FIFTH},
		// F
		{F4_NOTE, F4_NOTE + MAJOR_SECOND, F4_NOTE + MAJOR_THIRD, F4_NOTE + PERFECT_FOURTH, F4_NOTE + PERFECT_FIFTH},
		// F#/Gb
		{Gb4_NOTE, Gb4_NOTE + MAJOR_SECOND, Gb4_NOTE + MAJOR_THIRD, Gb4_NOTE + PERFECT_FOURTH, Gb4_NOTE + PERFECT_FIFTH},
		// G
		{G4_NOTE, G4_NOTE + MAJOR_SECOND, G4_NOTE + MAJOR_THIRD, G4_NOTE + PERFECT_FOURTH, G4_NOTE + PERFECT_FIFTH},
		// G#/Ab
		{Ab4_NOTE, Ab4_NOTE + MAJOR_SECOND, Ab4_NOTE + MAJOR_THIRD, Ab4_NOTE + PERFECT_FOURTH, Ab4_NOTE + PERFECT_FIFTH},
		// A
		{A4_NOTE, A4_NOTE + MAJOR_SECOND, A4_NOTE + MAJOR_THIRD, A4_NOTE + PERFECT_FOURTH, A4_NOTE + PERFECT_FIFTH},
		// A#/Bb
		{Bb4_NOTE, Bb4_NOTE + MAJOR_SECOND, Bb4_NOTE + MAJOR_THIRD, Bb4_NOTE + PERFECT_FOURTH, Bb4_NOTE + PERFECT_FIFTH},
		// B
		{B4_NOTE, B4_NOTE + MAJOR_SECOND, B4_NOTE + MAJOR_THIRD, B4_NOTE + PERFECT_FOURTH, B4_NOTE + PERFECT_FIFTH}},
	// Major Pentatonic
	{
		// C
		{C4_NOTE, C4_NOTE + MAJOR_SECOND, C4_NOTE + MAJOR_THIRD, C4_NOTE + PERFECT_FOURTH, C4_NOTE + PERFECT_FIFTH},
